...
class XPathBase
{
  ...
  public $bClassProfiling = FALSE;

  // Used to help navigate through the begin/end debug calls
  public $iDebugNextLinkNumber = 1;
  public $aDebugOpenLinks = array();
  public $aDebugFunctions = array(
   ...
   */
  public function _getEndGroups($string, $open='[', $close=']')
  {
    // Note that it doesn't make sense for $separator to itself contain (,),[ or ],
    // but as this is a private function we should be ok.
    $resultArr   = array();
...
//echo "close: $closePos\nopen: $openPos\n\n";
   ...
   */
  public function _beginDebugFunction($functionName, $bDebugFlag)
  {
    if ($bDebugFlag) {
   ...
   * @param     $bDebugFlag   (bool) TRUE if we are to draw a call stack, FALSE otherwise
   */
  public function _closeDebugFunction($functionName, $returnValue = "", $bDebugFlag)
  {
    if ($bDebugFlag) {
      echo "<hr>";
  ...
  /**
    * Profile begin call
    */
  public function _ProfBegin($sonFuncName)
  {
    public static $entryTmpl = array ( 'start' => array(),
                  'recursiveCount' => 0,
                  'totTime' => 0,
                  'callCount' => 0  );
   ...
   * Profile end call
   */
  public function _ProfEnd($sonFuncName)
  {
    $now = explode(' ', microtime());
   ...
   */
  public function _ProfileToHtml()
  {
    $sortArr = array();
   ...
   */
  public function _printContext($context)
  {
...
class XPathEngine extends XPathBase
{
  ...
  // XPath query.
  public $axes = array ( 'ancestor', 'ancestor_or_self', 'attribute', 'child', 'descendant',
  ...
  // in an XPath query.
  public $functions = array ( 'last', 'position', 'count', 'id', 'name',
  ...
  public $_indexIsDirty = FALSE;

  // These variable used during the parse XML source
  public $nodeStack       = array(); // The elements that we have still to close.
  public $parseStackIndex = 0;       // The current element of the nodeStack[] that we are adding to while
                                  ...
                                  // in our input data.
  public $parseOptions    = array(); // Used to set the PHP's XML parser options (see xml_parser_set_option)
   ...
   */
  public function XPathEngine($userXmlOptions=array())
  {
    parent::XPathBase();
   ...
   * @see setXmlOption
   */
  public function setXmlOptions($userXmlOptions=array())
  {
   ...
   *                         string value
   */
  public function _stringValue($node)
  {
   ...
   * @see _export()
   */
  public function exportAsHtml($absoluteXPath='', $hilightXpathList=array())
  {
   ...
   */
  public function exportToFile($fileName, $absoluteXPath='', $xmlHeader=NULL)
  {
    $status = FALSE;
    do { // try-block
...
//        $errStr = 'This xml document (string) was empty';
   ...
   */
  public function _createSuperRoot()
  {
    // Build a 'super-root'
...
*/
  ...
  public function match($xPathQuery, $baseXPath='')
  {
    ...
    public static $slashes2descendant = array(
    ...
    public static $dash2underscoreHash = array(
        '-sibling'    => '_sibling',
        '-or-'        => '_or_',
        'starts-with' => 'starts_with',
        'substring-before' => 'substring_before',
   ...
   *
   */
  public function _removeLiterals($xPathQuery)
  {
    ...
    if (preg_match(':^"([^"]*)"(.*)$:', $remainder, $aMatches)) {
      ...
      $literal = $aMatches[1];
      $remainder = $aMatches[2];
    } elseif (preg_match(":^'([^']*)'(.*)$:", $remainder, $aMatches)) {
      // A '' literal.
      $literal = $aMatches[1];
      $remainder = $aMatches[2];
    } else {
   ...
   */
  public function _asLiteral($string)
  {
   ...
   */
  public function _addLiteral($string)
  {
    // Store the literal
    $literalNumber = count($this->axPathLiterals);
   ...
   */
  public function _GetOperator($xPathQuery)
  {
    $position = 0;
    $operator = '';

    // The results of this function can easily be cached.
    public static $aResultsCache = array();
   ...
   * @see    evaluate()
   */
  public function _evaluatePrimaryExpr($xPathQuery, $context, &$result)
  {
   ...
   * @see    evaluate()
   */
  public function _evaluateExpr($xPathQuery, $context)
  {
   ...
   *                                 string (a sequence of UCS characters)
   */
  public function _evaluateOperator($left, $operator, $right, $operatorType, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _evaluatePathExpr($PathExpr, $context)
  {
   ...
   */
  public function _sortByDocOrder($xPathSet)
  {
   ...
   */
  public function _evaluateStep($steps, $context)
  {
   ...
   * @see    _evaluateStep()
   */
  public function _checkPredicates($xPathSet, $predicates)
  {
...
//          if ($bDebugThisFunction) {echo $this->_handleFunction_string($check, $context);}
   ...
   * @see    evaluate()
   */
  public function _evaluateFunction($function, $arguments, $context)
  {
...
//print_r($groups);
  ...
  //-----------------------------------------------------------------------------------------
    ...
    * @see    evaluate()
    */
  public function _handleFunction_last($arguments, $context)
  {
    return $context['size'];
  }
   ...
   * @see    evaluate()
   */
  public function _handleFunction_position($arguments, $context)
  {
    return $context['pos'];
  }
   ...
   * @see    evaluate()
   */
  public function _handleFunction_count($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_id($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_name($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_string($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_concat($arguments, $context)
  {
    // Split the arguments.
   ...
   * @see    evaluate()
   */
  public function _handleFunction_starts_with($arguments, $context)
  {
    // Get the arguments.
   ...
   * @see    evaluate()
   */
  public function _handleFunction_contains($arguments, $context)
  {
    // Get the arguments.
    $first  = trim($this->_prestr($arguments, ','));
    $second = trim($this->_afterstr($arguments, ','));
   ...
   * @see    evaluate()
   */
  public function _handleFunction_substring_before($arguments, $context)
  {
    // Get the arguments.
    $first  = trim($this->_prestr($arguments, ','));
    $second = trim($this->_afterstr($arguments, ','));
   ...
   * @see    evaluate()
   */
  public function _handleFunction_substring_after($arguments, $context)
  {
    // Get the arguments.
    $first  = trim($this->_prestr($arguments, ','));
    $second = trim($this->_afterstr($arguments, ','));
   ...
   * @see    evaluate()
   */
  public function _handleFunction_substring($arguments, $context)
  {
    // Split the arguments.
    $arguments = explode(",", $arguments);
    $size = sizeOf($arguments);
   ...
   * @see    evaluate()
   */
  public function _handleFunction_string_length($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_normalize_space($arguments, $context)
  {
    if (empty($arguments)) {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_translate($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_boolean($arguments, $context)
  {
    if (empty($arguments)) {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_not($arguments, $context)
  {
...
//echo "Before inversion: ".($bArgResult?"TRUE":"FALSE")."\n";
   ...
   * @see    evaluate()
   */
  public function _handleFunction_true($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_false($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_lang($arguments, $context)
  {
    $arguments = trim($arguments); // Trim the arguments.
   ...
   * @see    evaluate()
   */
  public function _handleFunction_number($arguments, $context)
  {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_sum($arguments, $context)
  {
    $arguments = trim($arguments); // Trim the arguments.
   ...
   * @see    evaluate()
   */
  public function _handleFunction_floor($arguments, $context)
  {
    if (!is_numeric($arguments)) {
   ...
   * @see    evaluate()
   */
  public function _handleFunction_ceiling($arguments, $context)
  {
    if (!is_numeric($arguments)) {
      $arguments = $this->_handleFunction_number($arguments, $context);
    }
   ...
   * @see    evaluate()
   */
  public function _handleFunction_round($arguments, $context)
  {
    if (!is_numeric($arguments)) {
      $arguments = $this->_handleFunction_number($arguments, $context);
    }
   ...
   * @see    evaluate()
   */
  public function _handleFunction_x_lower($arguments, $context)
  {
    // Evaluate the argument.
    $string = $this->_handleFunction_string($arguments, $context);
   ...
   * @see    evaluate()
   */
  public function _handleFunction_x_upper($arguments, $context)
  {
    // Evaluate the argument.
    $string = $this->_handleFunction_string($arguments, $context);
     // Return a reference to the lowercased string
   ...
   * @see    evaluate()
   */
  public function _handleFunction_generate_id($arguments, $context)
  {
  ...
  {
    public static $aEncodeTbl;
    public static $aDecodeTbl;
...
class XPath extends XPathEngine
{
   ...
   */
  public function XPath($fileName='', $userXmlOptions=array())
  {
   ...
   * @see getDataParts()
   */
  public function getData($xPathQuery)
  {
   ...
   * @see getData()
   */
  public function getDataParts($xPathQuery)
  {
    ...
    } elseif (preg_match(":(.*)/text\(\)(\[(.*)\])?$:U", $xPathQuery, $matches)) {
      $absoluteXPath = $matches[1];
   ...
   * @see    _resolveXPathQuery()
   */
  public function _resolveXPathQueryForNodeMod($xPathQuery, $functionName)
  {
    $xPathSet = array();
    if (empty($xPathQuery)) {
