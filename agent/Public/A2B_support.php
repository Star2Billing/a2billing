...
if (strlen($description)>0  && is_numeric($priority) && strlen($title)>0  && is_numeric($component)){
		...
		$QUERY = "INSERT INTO cc_ticket (creator,creator_type,title, description, id_component, priority) VALUES ('".$_SESSION['agent_id']."',1,'".$title."', '".$description."', '".$component."', '".$priority ."')";
