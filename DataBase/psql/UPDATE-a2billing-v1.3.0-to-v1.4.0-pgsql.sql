...
INSERT INTO cc_config (config_title, config_key, config_value, config_description, config_valuetype, config_group_id, config_listvalues) VALUES ('Go To Customer', 'go_to_customer', '../../A2BCustomer_UI/index.php', 'Link to the customer account', 0, 1, NULL);
