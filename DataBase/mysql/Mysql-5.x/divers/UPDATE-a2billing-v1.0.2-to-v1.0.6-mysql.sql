...
mysql -u root -p"root password" < UPDATE-a2billing-v1.0.2-to-v1.0.6-mysql.sql

*/



ALTER TABLE cc_call ADD COLUMN id_did INT;
...
CREATE TABLE cc_did_destination (
    ...
    destination TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
    activated INT DEFAULT 1 NOT NULL,
    secondusedreal INT DEFAULT 0,	
    id_trunk INT DEFAULT 0,
    PRIMARY KEY (id)
...
-- ALTER TABLE cc_call ADD COLUMN didcall INT;
-- ALTER TABLE cc_call ALTER COLUMN didcall SET DEFAULT 0;
-- UPDATE cc_call SET didcall = '0';
