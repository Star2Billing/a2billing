...
<div id="kiki"><div class="w1">
	<img src="'.KICON_PATH.'/gnome-finance.gif" class="kikipic"/>
	<div class="w2"><br>
'.gettext("Billing history - The section below allows you see all billing generated by the batch for the customers , or also to run a billing manualy for a specific customer. Note that this create one invoice associate to the created billing.").'
<br/>'.help_wiki_link('ViewPayments').'
</div></div></div>
</div></div>';
