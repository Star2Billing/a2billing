...
'.gettext("Each SIP/IAX client is identified by a number of parameters.</br></br>")
...
<div id="kiki"><div class="w1">
	<img src="'.KICON_PATH.'/gnome-finance.gif" class="kikipic"/>
	<div class="w2"><br>
'.gettext("Billing history - The section below allows you to see all billing generated by the batch for the customers, or also to run a billing manually for a specific customer. Note that this creates one invoice associated with the created billing.").'
<br/>'.help_wiki_link('ViewPayments').'
</div></div></div>
</div></div>';
...
<div id="kiki"><div class="w1">
	...
	.gettext("A ratecard is a set of rates defined and applied according to the dialing prefix, for instance 441 & 442 : UK Landline.").'<br>'
