...
function add_agi_confx($handle = null)
{
	...
	$group_title = "agi-conf".$agi_conf_number;
	
	$value = "'$group_title','$description'";
	$func_fields = "group_title,group_description";
	$func_table = 'cc_config_group';
	$id_name = "id";
	$insert_id = $instance_table -> Add_table ($handle, $value, $func_fields, $func_table, $id_name);

	$value = "SELECT config_title,config_key,config_value,config_description,config_valuetype,$insert_id,config_listvalues FROM cc_config WHERE config_group_id = $config_group_id";
